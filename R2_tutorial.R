...
for (___ in ___) {
  coefficients[___] <- cor(mtcars[___, ___], columns[___, ___]) 
}
...
# Formulas can take as many inputs as are necessary. A formula for standard error should take
...
voting_data <- read.csv('/Users/sgg24/Downloads/social_small.csv')
head(voting_data)
